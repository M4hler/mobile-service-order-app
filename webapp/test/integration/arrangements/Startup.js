sap.ui.define([
	"sap/ui/test/Opa5",
	"mobile-service-order-app-frontend/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("mobile-service-order-app-frontend.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "API_SERVICE_ORDER_SRV/" + sObjectId;
